...
//(1/42b 🗝️, 1/12.7m 🔑, 1/9.9m🔒,1/243.8m 🔏, 1/22.5m 🔐, , 🛎️, 1/345m ⛓️, 31.337m 🖇️ )
doorLayer = {
    "☘️" : 1/33300000000000,
    "🗝️" : 1/42000000000,
    "🛎️" : 1/4730000000,
...
//♟️(1/123.321b ⚖️, 1/34m 📐, 1/8.2m✏️ , 1/1.23b📌, 1/48.1m 📚, 1/16m 📖, 1/15.5m 🧠,  ,1/165m🖊️ )
chessLayer = {
    "☘️" : 1/33300000000000,
    "⚖️" : 1/123321000000,
    "📌" : 1/1230000000,
...
function setLayer(y) {
    if (currentWorld === 1) {
        let tempNum = y;
        if (tempNum < worldOneLayers.length * 2000) {
